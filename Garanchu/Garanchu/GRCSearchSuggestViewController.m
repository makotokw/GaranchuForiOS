//
//  GRCSearchSuggestViewController.m
//  Garanchu
//
...
@interface GRCSearchSuggestViewController () <UISearchBarDelegate>

@end

@implementation GRCSearchSuggestViewController
...
- (void)viewDidLoad
{
    ...
    _searchBar.placeholder = GRCLocalizedString(@"SearchBarPlaceHolder");
